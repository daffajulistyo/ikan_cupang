...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#" class="text-danger"><img src="https://image.flaticon.com/icons/png/512/1318/1318634.png" width="40px"> IKAN CUPANG</a>
    ...
    <div class="container mt-5" style="width: 33%;">
        <form class="mb-4" action="/store" method="POST">
            @csrf
            <h1 class="text-center mb-4">Create Fish</h1>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="penjual">
            </div>
            <div class="form-group">
                <label for="">Foto Ikan</label>
                <input type="text" class="form-control" name="foto_ikan" >
            </div>
